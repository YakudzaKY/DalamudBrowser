...
public class Benchmark
{
    public static void Run()
    {
        ...
        {
            BrowserUrlUtilityBaseline.TryGetActOverlayWebSocket(testUri.AbsoluteUri, out _);
            BrowserUrlUtilityBaseline.TryGetActOverlayWebSocket(testUri2.AbsoluteUri, out _);
            BrowserUrlUtilityBaseline.TryGetActOverlayWebSocket(testUri3.AbsoluteUri, out _);
            BrowserUrlUtilityBaseline.TryGetActOverlayWebSocket(testUri4.AbsoluteUri, out _);
        }
        ...
        sw.Stop();
        Console.WriteLine($"TryGetActOverlayWebSocket (baseline string.Split) took {sw.ElapsedMilliseconds} ms");
        ...
        sw.Stop();
        Console.WriteLine($"TryGetActOverlayWebSocket (optimized ReadOnlySpan) took {sw.ElapsedMilliseconds} ms");
    }
}
